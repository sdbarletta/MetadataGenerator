...
@XmlRootElement(name = "initMetadataConnectionResponse", namespace = "http://metadata.salesforce.sdbarletta.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "initMetadataConnectionResponse", namespace = "http://metadata.salesforce.sdbarletta.com/")
public class InitMetadataConnectionResponse {
